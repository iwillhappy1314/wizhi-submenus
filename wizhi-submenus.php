<?php
	...
	*/
	...
	class wizhi_submenus extends WP_Widget {
		...
		public function __construct() {
			$widget_options = array(
				'classname'   => 'set_contact',
				'description' => 'Display page`s subpage list
			and taxonomy terms list belongs to a post type',
			);
	...
	add_action( 'widgets_init', create_function( '', 'return register_widget("wizhi_submenus");' ) );