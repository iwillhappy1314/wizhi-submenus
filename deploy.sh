...
# main config
PLUGINSLUG="wizhi-submenus"
CURRENTDIR=`pwd`
MAINFILE="wizhi-submenus" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/wizhi-submenus/" # Remote SVN repo on wordpress.org, with trailing slash
